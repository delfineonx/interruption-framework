...
{
let I={},D=0,N=0,E=1,F={state:1,handler:()=>{},args:[],delay:0,limit:2};
Object.defineProperty(globalThis.InternalError.prototype,"name",{configurable:!0,get:()=>{if(F.state&E){I[++D]=[F.handler,F.args,F.delay+N-1,F.limit]}E=1;return"Interruption Framework"}});
